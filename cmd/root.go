...
//
//  //rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.IP2Country.yaml)")
//
//
...
//    }
//
//    // Search config in home directory with name ".IP2Country" (without extension).
//    viper.AddConfigPath(home)
//    viper.SetConfigName(".IP2Country")
//  }
//
